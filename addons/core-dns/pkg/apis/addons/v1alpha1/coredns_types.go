...
var _ addon.CommonObject = &CoreDNS{}

func (o *CoreDNS) ComponentName() string {
	return "coredns"
}

func (o *CoreDNS) CommonSpec() addon.CommonSpec {
	return o.Spec.CommonSpec
}

func (o *CoreDNS) GetCommonStatus() addon.CommonStatus {
	return o.Status.CommonStatus
}

func (o *CoreDNS) SetCommonStatus(s addon.CommonStatus) {
